...
//
//		google::SetStderrLogging(google::INFO);						//	设置级别高于 google::INFO的日志同一时候输出到屏幕
//		FLAGS_colorlogtostderr=true;								//	设置输出到屏幕的日志显示对应颜色
//
//		google::SetLogDestination(google::INFO,logName);			//	设置 google::INFO 级别的日志存储路径和文件名称前缀		
//		//google::SetLogDestination(google::WARNING,"WARNING_");	//	设置 google::WARNING 级别的日志存储路径和文件名称前缀		
//		//google::SetLogDestination(google::ERROR,"ERROR_");		//	设置 google::ERROR 级别的日志存储路径和文件名称前缀
//
